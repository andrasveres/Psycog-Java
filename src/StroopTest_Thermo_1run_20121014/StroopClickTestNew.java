...
public class StroopClickTestNew extends JPanel implements MouseListener, MouseMotionListener {
	...
	public StroopClickTestNew(String participant, int ntot, String[] names, Color[] colors, StroopInterface launcher) {
        ...
        String ss;
     	ss = 
     		"Ebben a bemelegítő feladatban a képernyő közepén egy plusz jel megjelenése \n" +
     		"után egy színes négyzetet fogsz látni. Az alsó négy \n" +
	...
	*/
	...
	void CalcResult() throws IOException {
		...
		for(int i=0; i<N; i++) {
			ClickTrialNew trial = set.trial[i];
		...
		output.write(names[0]+"\t"+names[2]+"\t"+names[1]+"\t"+names[3]+"\r\n");
		
		output.write("Color\tCorrect\tDelay\r\n");
